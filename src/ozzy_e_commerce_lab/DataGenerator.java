...
import ozzy_e_commerce_lab.balance.Balance;
import ozzy_e_commerce_lab.balance.CustomerBalance;
import ozzy_e_commerce_lab.balance.GiftCardBalance;
import ozzy_e_commerce_lab.category.Category;
import ozzy_e_commerce_lab.category.Electronic;
import ozzy_e_commerce_lab.category.Furniture;
import ozzy_e_commerce_lab.category.SkinCare;
import ozzy_e_commerce_lab.discount.AmountBasedDiscount;
import ozzy_e_commerce_lab.discount.Discount;
import ozzy_e_commerce_lab.discount.RateBasedDiscount;
...
// what was if it is static either, you can call with the class name or you need to import a static
    ...
    public static void createCategory(){
        Category category1 = new Electronic(UUID.randomUUID(), "Electronic"); // we use polymorphism, left side basic parent, right side is the child
